...
int main()
{
    OrquestaAuxiliar orqAux[MAX_MUSICO];
            ...
            do
            {
                ...
                switch (opcionInformes)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        musicosQueNoSuperan25(musicos,MAX_MUSICO,instrumentos,MAX_INSTRUMENTO);
                        break;
                    case 3:
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        promedio_cantidad_instrumentos_por_orquesta(instrumentos,orquestas,MAX_INSTRUMENTO,MAX_ORQUESTA);
                        break;
                    case 8:
                        break;
                    default:
